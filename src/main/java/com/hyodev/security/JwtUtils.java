...
public class JwtUtils {
  private static final long EXPIRATION_TIME_IN_MILLISEC = 1000L * 60L * 24L * 30L * 6L; // expirers 6 months

  private SecretKey key;

  @Value("${secreteJwtString}")
  private String secreteJwtString;// make sure the value in the application propeties in 32char or long
